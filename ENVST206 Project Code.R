...
plot(NewYork$NO2.Mean, NewYork$O3.Mean,
     ...
     pch = 19,
     col = "royalblue4",
     ylab = "O3 Daily Mean", xlab = "NO2 Daily Mean")
...
plot(NewYork$CO.Mean, NewYork$O3.Mean,
     ...
     pch = 19,
     col = "slateblue1",
     ylab = "O3 Daily Mean", xlab = "CO Daily Mean")
...
plot(SO2_log, NewYork$O3.Mean,
     ...
     pch = 19,
     col = "tomato",
     ylab = "O3 Daily Mean", xlab = "log(SO2 +1) Daily Mean")
...
plot(SO2_log, NewYork$NO2.Mean,
     ...
     pch = 19,
     col = "purple2",
     ylab = "NO2 Daily Mean", xlab = "log(SO2 +1) Daily Mean")
...
plot(NewYork$CO.Mean, NewYork$NO2.Mean,
     ...
     pch = 19,
     col = "red3",
     ylab = "NO2 Daily Mean", xlab = "CO Daily Mean")
...
plot(SO2_log, NewYork$CO.Mean,
     ...
     pch = 19,
     col = "navy",
     ylab = "CO Daily Mean", xlab = "log(SO2 +1) Daily Mean")
